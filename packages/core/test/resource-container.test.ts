...
describe("resource containers", () => {
  ...
  it("resolves and lists normalized resource paths", () => {
    ...
    expect(
      container.resolvePath("OPS/text/chapter.xhtml", "../images/a.png")
    ).toBe("OPS/images/a.png")
  ...
  it("unzips a ZIP archive and builds a resource index", async () => {
    ...
    await expect(
      container.readText("META-INF/container.xml")
    ).resolves.toContain("OPS/content.opf")

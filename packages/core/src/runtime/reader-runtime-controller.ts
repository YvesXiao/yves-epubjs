...
import type { ReaderOperationSession } from "./reader-operation-session"
...
export interface ReaderRuntimeHost {
  ...
  operationSession: ReaderOperationSession
  ...
  getClientPointForContainerPoint(point: Point): { x: number; y: number } | null
  ...
  resolveAnnotationRange(annotation: Annotation): ResolvedAnnotationRange | null
...
export class ReaderRuntimeController {
  ...
  getSectionAccessibilitySnapshot(
    ...
    return this.runtimeApiController.getSectionAccessibilitySnapshot(spineIndex)
  }
  ...
  handlePaginatedViewportClick(event: MouseEvent): void {
    return this.runtimeInteractionController.handlePaginatedViewportClick(event)
  }
  ...
  mapDomViewportPointToLocator(point: Point): Locator | null {
    return this.runtimeInteractionController.mapDomViewportPointToLocator(point)
  }
  ...
  collectVisibleBoundsForScroll(
    ...
    return this.scrollController.collectVisibleBoundsForScroll(sectionsToRender)
  }
  ...
  resolveAnnotationRange(
    ...
    return this.selectionAnnotationController.resolveAnnotationRange(annotation)
  }

...
import { ReaderOperationSession } from "./reader-operation-session"
...
export class EpubReader {
  ...
  protected readonly operationSession = new ReaderOperationSession()
  ...
  constructor(protected readonly options: ReaderOptions = {}) {
    ...
    const settings = resolveReaderSettings(preferences, DEFAULT_READER_SETTINGS)
  ...
  protected performPaginatedNavigationAction(
  ...
  protected resolveDisplayPageNumberToLeafPage(
    ...
    return this.runtimeController.resolveDisplayPageNumberToLeafPage(pageNumber)
  }
  ...
  protected getActiveCanvasBlockIdForSection(
    ...
    return this.runtimeController.getActiveCanvasBlockIdForSection(sectionIndex)
  }
